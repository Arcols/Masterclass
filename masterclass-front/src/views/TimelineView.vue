      ...
      <div class="max-w-3xl mx-auto w-full">
        ...
        <div class="flex items-start md:items-center justify-between gap-2 mb-5 md:mb-6">
          ...
          <div class="flex flex-col md:flex-row md:items-center gap-1 md:gap-3">
            <h1 class="text-lg md:text-2xl font-bold text-[var(--color-black)] leading-tight">Timeline Devoirs/Examens</h1>
            <span class="bg-[var(--color-primary)] text-white text-[9px] md:text-[10px] font-bold px-2 py-0.5 md:px-3 md:py-1 rounded-full uppercase tracking-widest shadow-sm w-fit">
              Prochainement
            </span>
          </div>

...
<template>
  <div class="flex flex-col h-full bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm">
    ...
    <div class="flex items-center justify-between px-4 py-3 border-b border-gray-200 bg-white z-50">
      ...
      <div class="flex items-center gap-1">
        <button @click="prevWeek" class="p-1.5 rounded-full hover:bg-gray-100 transition-colors cursor-pointer text-gray-600">
          <ChevronLeftIcon class="w-5 h-5" />
        </button>
        <button @click="nextWeek" class="p-1.5 rounded-full hover:bg-gray-100 transition-colors cursor-pointer text-gray-600">
    ...
    <div class="flex-1 overflow-auto relative flex flex-col">
      ...
      <div class="sticky top-0 z-40 flex border-b border-gray-200 bg-white shadow-sm shrink-0">
        <div class="w-14 md:w-16 shrink-0 sticky left-0 z-50 bg-white border-r border-gray-100"></div>
        ...
        <div class="flex-1 grid grid-cols-7 min-w-[700px]">
          <div
            ...
            :class="day.isToday ? 'text-[var(--color-primary)] font-bold' : 'text-gray-600 font-medium'"
          >
